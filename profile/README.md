...
| [human-dynamics-estimation-backup](https://github.com/robotology/human-dynamics-estimation-backup) | | |
| [human-gazebo-backup](https://github.com/robotology/human-gazebo-backup) | | |
...
| [mesh-support](https://github.com/robotology/mesh-support) | Virtual repository that provides support requests for individual robots| |
...
| [idyntree-backup](https://github.com/robotology/idyntree-backup) | | |
| [idyntree-yarp-tools-backup](https://github.com/robotology/idyntree-yarp-tools-backup) | | [![Build Status](https://github.com/robotology/idyntree-yarp-tools-backup/workflows/CI%20Workflow/badge.svg)](https://github.com/robotology/idyntree-yarp-tools-backup/actions?query=workflow%3A%22CI+Workflow%22)|
...
| [osqp-eigen-backup](https://github.com/robotology/osqp-eigen-backup) | | |
...
| [unicycle-footstep-planner-backup](https://github.com/robotology/unicycle-footstep-planner-backup) | | |
...
| [walking-controllers-backup](https://github.com/robotology/walking-controllers-backup) | | |
| [walking-teleoperation-backup](https://github.com/robotology/walking-teleoperation-backup) | | |
...
| [whole-body-estimators-backup](https://github.com/robotology/whole-body-estimators-backup) | | [![Build Status](https://github.com/robotology/whole-body-estimators-backup/workflows/CI%20Workflow/badge.svg)](https://github.com/robotology/whole-body-estimators-backup/actions?query=workflow%3A%22CI+Workflow%22)|
...
| [yarp-device-xhand](https://github.com/robotology/yarp-device-xhand) | Device to use the Robotera XHand1 with yarp| |
